...
const AdminEnrolments = ({ user, onNav }) => {
  const initial = [
  ...
  return (
    <Shell navItems={ADMIN_NAV} active="enrolments" onNav={onNav} user={user} title="Enrolments" accent="Administrator" onLogout={() => onNav("logout")} notifications={ADMIN_NOTIFS}>
      <div className="page">
        <div className="page-header">
          <div>
...
const AdminStubPage = ({ user, onNav, active, title, eyebrow, blurb, ico, body }) => (
  <Shell navItems={ADMIN_NAV} active={active} onNav={onNav} user={user} title={title} accent="Administrator" onLogout={() => onNav("logout")} notifications={ADMIN_NOTIFS}>
    <div className="page">
...
const SuperAdminStubPage = ({ user, onNav, active, title, eyebrow, blurb, ico, body }) => (
  <Shell navItems={SUPERADMIN_NAV} active={active} onNav={onNav} user={user} title={title} accent="Super Admin" onLogout={() => onNav("logout")} notifications={SUPER_NOTIFS}>
    <div className="page">
      <div className="page-header"><div><h1>{title}</h1><div className="greeting">{eyebrow}</div></div></div>
      <div className="stub-card">
        <div className="stub-ico"><Icon name={ico} size={28} /></div>
